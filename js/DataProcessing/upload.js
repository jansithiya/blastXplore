...
function processUpload(file1) {
    ...
    var smessage = $('#uploadmessage').addClass("alert alert-success").addClass("run-animation").html("<strong> Success! </strong> file uploaded successfully please proceed to step 2").show();
            ...
            $("#Taxonomy").click(function (e) {
                ...
                window.open("http://localhost:8888/BLAST-Xplore/pages/Taxonomy/taxonomy.html");
            ...
            $("#Overview").click(function (e) {
                ...
                e.preventDefault();
                window.open("http://localhost:8888/BLAST-Xplore/pages/Overview/overview.html");
            ...
            $("#BlastCloud").click(function (e) {
                ...
                window.open("http://localhost:8888/BLAST-Xplore/pages/Wordle/titleCloud.html");
            });
            ...
            $("#SequenceAlignment").click(function (e) {
                ...
                window.open("http://localhost:8888/BLAST-Xplore/pages/Sequences/sequence_home.html");
            });
